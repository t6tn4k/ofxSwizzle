...
protected:
    union
    {
        ...
        proxy_type<0, 0, 0, 0> xyxx;
        proxy_type<0, 0, 0, 1> xyxy;
        proxy_type<0, 0, 0, 2> xyxz;
        proxy_type<0, 0, 0, 3> xyxw;
        proxy_type<0, 0, 1, 0> xyyx;
        proxy_type<0, 0, 1, 1> xyyy;
        proxy_type<0, 0, 1, 2> xyyz;
        proxy_type<0, 0, 1, 3> xyyw;
        proxy_type<0, 0, 2, 0> xyzx;
        proxy_type<0, 0, 2, 1> xyzy;
        proxy_type<0, 0, 2, 2> xyzz;
        proxy_type<0, 0, 2, 3> xyzw;
        proxy_type<0, 0, 3, 0> xywx;
        proxy_type<0, 0, 3, 1> xywy;
        proxy_type<0, 0, 3, 2> xywz;
        proxy_type<0, 0, 3, 3> xyww;
        proxy_type<0, 0, 0, 0> xzxx;
        proxy_type<0, 0, 0, 1> xzxy;
        proxy_type<0, 0, 0, 2> xzxz;
        proxy_type<0, 0, 0, 3> xzxw;
        proxy_type<0, 0, 1, 0> xzyx;
        proxy_type<0, 0, 1, 1> xzyy;
        proxy_type<0, 0, 1, 2> xzyz;
        proxy_type<0, 0, 1, 3> xzyw;
        proxy_type<0, 0, 2, 0> xzzx;
        proxy_type<0, 0, 2, 1> xzzy;
        proxy_type<0, 0, 2, 2> xzzz;
        proxy_type<0, 0, 2, 3> xzzw;
        proxy_type<0, 0, 3, 0> xzwx;
        proxy_type<0, 0, 3, 1> xzwy;
        proxy_type<0, 0, 3, 2> xzwz;
        proxy_type<0, 0, 3, 3> xzww;
        proxy_type<0, 0, 0, 0> xwxx;
        proxy_type<0, 0, 0, 1> xwxy;
        proxy_type<0, 0, 0, 2> xwxz;
        proxy_type<0, 0, 0, 3> xwxw;
        proxy_type<0, 0, 1, 0> xwyx;
        proxy_type<0, 0, 1, 1> xwyy;
        proxy_type<0, 0, 1, 2> xwyz;
        proxy_type<0, 0, 1, 3> xwyw;
        proxy_type<0, 0, 2, 0> xwzx;
        proxy_type<0, 0, 2, 1> xwzy;
        proxy_type<0, 0, 2, 2> xwzz;
        proxy_type<0, 0, 2, 3> xwzw;
        proxy_type<0, 0, 3, 0> xwwx;
        proxy_type<0, 0, 3, 1> xwwy;
        proxy_type<0, 0, 3, 2> xwwz;
        proxy_type<0, 0, 3, 3> xwww;
        proxy_type<1, 0, 0, 0> yxxx;
        proxy_type<1, 0, 0, 1> yxxy;
        proxy_type<1, 0, 0, 2> yxxz;
        ...
        proxy_type<1, 0, 0, 0> yyxx;
        proxy_type<1, 0, 0, 1> yyxy;
        proxy_type<1, 0, 0, 2> yyxz;
        proxy_type<1, 0, 0, 3> yyxw;
        proxy_type<1, 0, 1, 0> yyyx;
        proxy_type<1, 0, 1, 1> yyyy;
        proxy_type<1, 0, 1, 2> yyyz;
        proxy_type<1, 0, 1, 3> yyyw;
        proxy_type<1, 0, 2, 0> yyzx;
        proxy_type<1, 0, 2, 1> yyzy;
        proxy_type<1, 0, 2, 2> yyzz;
        proxy_type<1, 0, 2, 3> yyzw;
        proxy_type<1, 0, 3, 0> yywx;
        proxy_type<1, 0, 3, 1> yywy;
        proxy_type<1, 0, 3, 2> yywz;
        proxy_type<1, 0, 3, 3> yyww;
        proxy_type<1, 0, 0, 0> yzxx;
        proxy_type<1, 0, 0, 1> yzxy;
        proxy_type<1, 0, 0, 2> yzxz;
        proxy_type<1, 0, 0, 3> yzxw;
        proxy_type<1, 0, 1, 0> yzyx;
        proxy_type<1, 0, 1, 1> yzyy;
        proxy_type<1, 0, 1, 2> yzyz;
        proxy_type<1, 0, 1, 3> yzyw;
        proxy_type<1, 0, 2, 0> yzzx;
        proxy_type<1, 0, 2, 1> yzzy;
        proxy_type<1, 0, 2, 2> yzzz;
        proxy_type<1, 0, 2, 3> yzzw;
        proxy_type<1, 0, 3, 0> yzwx;
        proxy_type<1, 0, 3, 1> yzwy;
        proxy_type<1, 0, 3, 2> yzwz;
        proxy_type<1, 0, 3, 3> yzww;
        proxy_type<1, 0, 0, 0> ywxx;
        proxy_type<1, 0, 0, 1> ywxy;
        proxy_type<1, 0, 0, 2> ywxz;
        proxy_type<1, 0, 0, 3> ywxw;
        proxy_type<1, 0, 1, 0> ywyx;
        proxy_type<1, 0, 1, 1> ywyy;
        proxy_type<1, 0, 1, 2> ywyz;
        proxy_type<1, 0, 1, 3> ywyw;
        proxy_type<1, 0, 2, 0> ywzx;
        proxy_type<1, 0, 2, 1> ywzy;
        proxy_type<1, 0, 2, 2> ywzz;
        proxy_type<1, 0, 2, 3> ywzw;
        proxy_type<1, 0, 3, 0> ywwx;
        proxy_type<1, 0, 3, 1> ywwy;
        proxy_type<1, 0, 3, 2> ywwz;
        proxy_type<1, 0, 3, 3> ywww;
        proxy_type<2, 0, 0, 0> zxxx;
        proxy_type<2, 0, 0, 1> zxxy;
        proxy_type<2, 0, 0, 2> zxxz;
        ...
        proxy_type<2, 0, 0, 0> zyxx;
        proxy_type<2, 0, 0, 1> zyxy;
        proxy_type<2, 0, 0, 2> zyxz;
        proxy_type<2, 0, 0, 3> zyxw;
        proxy_type<2, 0, 1, 0> zyyx;
        proxy_type<2, 0, 1, 1> zyyy;
        proxy_type<2, 0, 1, 2> zyyz;
        proxy_type<2, 0, 1, 3> zyyw;
        proxy_type<2, 0, 2, 0> zyzx;
        proxy_type<2, 0, 2, 1> zyzy;
        proxy_type<2, 0, 2, 2> zyzz;
        proxy_type<2, 0, 2, 3> zyzw;
        proxy_type<2, 0, 3, 0> zywx;
        proxy_type<2, 0, 3, 1> zywy;
        proxy_type<2, 0, 3, 2> zywz;
        proxy_type<2, 0, 3, 3> zyww;
        proxy_type<2, 0, 0, 0> zzxx;
        proxy_type<2, 0, 0, 1> zzxy;
        proxy_type<2, 0, 0, 2> zzxz;
        proxy_type<2, 0, 0, 3> zzxw;
        proxy_type<2, 0, 1, 0> zzyx;
        proxy_type<2, 0, 1, 1> zzyy;
        proxy_type<2, 0, 1, 2> zzyz;
        proxy_type<2, 0, 1, 3> zzyw;
        proxy_type<2, 0, 2, 0> zzzx;
        proxy_type<2, 0, 2, 1> zzzy;
        proxy_type<2, 0, 2, 2> zzzz;
        proxy_type<2, 0, 2, 3> zzzw;
        proxy_type<2, 0, 3, 0> zzwx;
        proxy_type<2, 0, 3, 1> zzwy;
        proxy_type<2, 0, 3, 2> zzwz;
        proxy_type<2, 0, 3, 3> zzww;
        proxy_type<2, 0, 0, 0> zwxx;
        proxy_type<2, 0, 0, 1> zwxy;
        proxy_type<2, 0, 0, 2> zwxz;
        proxy_type<2, 0, 0, 3> zwxw;
        proxy_type<2, 0, 1, 0> zwyx;
        proxy_type<2, 0, 1, 1> zwyy;
        proxy_type<2, 0, 1, 2> zwyz;
        proxy_type<2, 0, 1, 3> zwyw;
        proxy_type<2, 0, 2, 0> zwzx;
        proxy_type<2, 0, 2, 1> zwzy;
        proxy_type<2, 0, 2, 2> zwzz;
        proxy_type<2, 0, 2, 3> zwzw;
        proxy_type<2, 0, 3, 0> zwwx;
        proxy_type<2, 0, 3, 1> zwwy;
        proxy_type<2, 0, 3, 2> zwwz;
        proxy_type<2, 0, 3, 3> zwww;
        ...
        proxy_type<3, 0, 0, 0> wyxx;
        proxy_type<3, 0, 0, 1> wyxy;
        proxy_type<3, 0, 0, 2> wyxz;
        proxy_type<3, 0, 0, 3> wyxw;
        proxy_type<3, 0, 1, 0> wyyx;
        proxy_type<3, 0, 1, 1> wyyy;
        proxy_type<3, 0, 1, 2> wyyz;
        proxy_type<3, 0, 1, 3> wyyw;
        proxy_type<3, 0, 2, 0> wyzx;
        proxy_type<3, 0, 2, 1> wyzy;
        proxy_type<3, 0, 2, 2> wyzz;
        proxy_type<3, 0, 2, 3> wyzw;
        proxy_type<3, 0, 3, 0> wywx;
        proxy_type<3, 0, 3, 1> wywy;
        proxy_type<3, 0, 3, 2> wywz;
        proxy_type<3, 0, 3, 3> wyww;
        proxy_type<3, 0, 0, 0> wzxx;
        proxy_type<3, 0, 0, 1> wzxy;
        proxy_type<3, 0, 0, 2> wzxz;
        proxy_type<3, 0, 0, 3> wzxw;
        proxy_type<3, 0, 1, 0> wzyx;
        proxy_type<3, 0, 1, 1> wzyy;
        proxy_type<3, 0, 1, 2> wzyz;
        proxy_type<3, 0, 1, 3> wzyw;
        proxy_type<3, 0, 2, 0> wzzx;
        proxy_type<3, 0, 2, 1> wzzy;
        proxy_type<3, 0, 2, 2> wzzz;
        proxy_type<3, 0, 2, 3> wzzw;
        proxy_type<3, 0, 3, 0> wzwx;
        proxy_type<3, 0, 3, 1> wzwy;
        proxy_type<3, 0, 3, 2> wzwz;
        proxy_type<3, 0, 3, 3> wzww;
        proxy_type<3, 0, 0, 0> wwxx;
        proxy_type<3, 0, 0, 1> wwxy;
        proxy_type<3, 0, 0, 2> wwxz;
        proxy_type<3, 0, 0, 3> wwxw;
        proxy_type<3, 0, 1, 0> wwyx;
        proxy_type<3, 0, 1, 1> wwyy;
        proxy_type<3, 0, 1, 2> wwyz;
        proxy_type<3, 0, 1, 3> wwyw;
        proxy_type<3, 0, 2, 0> wwzx;
        proxy_type<3, 0, 2, 1> wwzy;
        proxy_type<3, 0, 2, 2> wwzz;
        proxy_type<3, 0, 2, 3> wwzw;
        proxy_type<3, 0, 3, 0> wwwx;
        proxy_type<3, 0, 3, 1> wwwy;
        proxy_type<3, 0, 3, 2> wwwz;
        proxy_type<3, 0, 3, 3> wwww;
        ...
        proxy_type<0, 0, 0, 0> rgrr;
        proxy_type<0, 0, 0, 1> rgrg;
        proxy_type<0, 0, 0, 2> rgrb;
        proxy_type<0, 0, 0, 3> rgra;
        proxy_type<0, 0, 1, 0> rggr;
        proxy_type<0, 0, 1, 1> rggg;
        proxy_type<0, 0, 1, 2> rggb;
        proxy_type<0, 0, 1, 3> rgga;
        proxy_type<0, 0, 2, 0> rgbr;
        proxy_type<0, 0, 2, 1> rgbg;
        proxy_type<0, 0, 2, 2> rgbb;
        proxy_type<0, 0, 2, 3> rgba;
        proxy_type<0, 0, 3, 0> rgar;
        proxy_type<0, 0, 3, 1> rgag;
        proxy_type<0, 0, 3, 2> rgab;
        proxy_type<0, 0, 3, 3> rgaa;
        proxy_type<0, 0, 0, 0> rbrr;
        proxy_type<0, 0, 0, 1> rbrg;
        proxy_type<0, 0, 0, 2> rbrb;
        proxy_type<0, 0, 0, 3> rbra;
        proxy_type<0, 0, 1, 0> rbgr;
        proxy_type<0, 0, 1, 1> rbgg;
        proxy_type<0, 0, 1, 2> rbgb;
        proxy_type<0, 0, 1, 3> rbga;
        proxy_type<0, 0, 2, 0> rbbr;
        proxy_type<0, 0, 2, 1> rbbg;
        proxy_type<0, 0, 2, 2> rbbb;
        proxy_type<0, 0, 2, 3> rbba;
        proxy_type<0, 0, 3, 0> rbar;
        proxy_type<0, 0, 3, 1> rbag;
        proxy_type<0, 0, 3, 2> rbab;
        proxy_type<0, 0, 3, 3> rbaa;
        proxy_type<0, 0, 0, 0> rarr;
        proxy_type<0, 0, 0, 1> rarg;
        proxy_type<0, 0, 0, 2> rarb;
        proxy_type<0, 0, 0, 3> rara;
        proxy_type<0, 0, 1, 0> ragr;
        proxy_type<0, 0, 1, 1> ragg;
        proxy_type<0, 0, 1, 2> ragb;
        proxy_type<0, 0, 1, 3> raga;
        proxy_type<0, 0, 2, 0> rabr;
        proxy_type<0, 0, 2, 1> rabg;
        proxy_type<0, 0, 2, 2> rabb;
        proxy_type<0, 0, 2, 3> raba;
        proxy_type<0, 0, 3, 0> raar;
        proxy_type<0, 0, 3, 1> raag;
        proxy_type<0, 0, 3, 2> raab;
        proxy_type<0, 0, 3, 3> raaa;
        proxy_type<1, 0, 0, 0> grrr;
        proxy_type<1, 0, 0, 1> grrg;
        proxy_type<1, 0, 0, 2> grrb;
        ...
        proxy_type<1, 0, 0, 0> ggrr;
        proxy_type<1, 0, 0, 1> ggrg;
        proxy_type<1, 0, 0, 2> ggrb;
        proxy_type<1, 0, 0, 3> ggra;
        proxy_type<1, 0, 1, 0> gggr;
        proxy_type<1, 0, 1, 1> gggg;
        proxy_type<1, 0, 1, 2> gggb;
        proxy_type<1, 0, 1, 3> ggga;
        proxy_type<1, 0, 2, 0> ggbr;
        proxy_type<1, 0, 2, 1> ggbg;
        proxy_type<1, 0, 2, 2> ggbb;
        proxy_type<1, 0, 2, 3> ggba;
        proxy_type<1, 0, 3, 0> ggar;
        proxy_type<1, 0, 3, 1> ggag;
        proxy_type<1, 0, 3, 2> ggab;
        proxy_type<1, 0, 3, 3> ggaa;
        proxy_type<1, 0, 0, 0> gbrr;
        proxy_type<1, 0, 0, 1> gbrg;
        proxy_type<1, 0, 0, 2> gbrb;
        proxy_type<1, 0, 0, 3> gbra;
        proxy_type<1, 0, 1, 0> gbgr;
        proxy_type<1, 0, 1, 1> gbgg;
        proxy_type<1, 0, 1, 2> gbgb;
        proxy_type<1, 0, 1, 3> gbga;
        proxy_type<1, 0, 2, 0> gbbr;
        proxy_type<1, 0, 2, 1> gbbg;
        proxy_type<1, 0, 2, 2> gbbb;
        proxy_type<1, 0, 2, 3> gbba;
        proxy_type<1, 0, 3, 0> gbar;
        proxy_type<1, 0, 3, 1> gbag;
        proxy_type<1, 0, 3, 2> gbab;
        proxy_type<1, 0, 3, 3> gbaa;
        proxy_type<1, 0, 0, 0> garr;
        proxy_type<1, 0, 0, 1> garg;
        proxy_type<1, 0, 0, 2> garb;
        proxy_type<1, 0, 0, 3> gara;
        proxy_type<1, 0, 1, 0> gagr;
        proxy_type<1, 0, 1, 1> gagg;
        proxy_type<1, 0, 1, 2> gagb;
        proxy_type<1, 0, 1, 3> gaga;
        proxy_type<1, 0, 2, 0> gabr;
        proxy_type<1, 0, 2, 1> gabg;
        proxy_type<1, 0, 2, 2> gabb;
        proxy_type<1, 0, 2, 3> gaba;
        proxy_type<1, 0, 3, 0> gaar;
        proxy_type<1, 0, 3, 1> gaag;
        proxy_type<1, 0, 3, 2> gaab;
        proxy_type<1, 0, 3, 3> gaaa;
        proxy_type<2, 0, 0, 0> brrr;
        proxy_type<2, 0, 0, 1> brrg;
        proxy_type<2, 0, 0, 2> brrb;
        ...
        proxy_type<2, 0, 0, 0> bgrr;
        proxy_type<2, 0, 0, 1> bgrg;
        proxy_type<2, 0, 0, 2> bgrb;
        proxy_type<2, 0, 0, 3> bgra;
        proxy_type<2, 0, 1, 0> bggr;
        proxy_type<2, 0, 1, 1> bggg;
        proxy_type<2, 0, 1, 2> bggb;
        proxy_type<2, 0, 1, 3> bgga;
        proxy_type<2, 0, 2, 0> bgbr;
        proxy_type<2, 0, 2, 1> bgbg;
        proxy_type<2, 0, 2, 2> bgbb;
        proxy_type<2, 0, 2, 3> bgba;
        proxy_type<2, 0, 3, 0> bgar;
        proxy_type<2, 0, 3, 1> bgag;
        proxy_type<2, 0, 3, 2> bgab;
        proxy_type<2, 0, 3, 3> bgaa;
        proxy_type<2, 0, 0, 0> bbrr;
        proxy_type<2, 0, 0, 1> bbrg;
        proxy_type<2, 0, 0, 2> bbrb;
        proxy_type<2, 0, 0, 3> bbra;
        proxy_type<2, 0, 1, 0> bbgr;
        proxy_type<2, 0, 1, 1> bbgg;
        proxy_type<2, 0, 1, 2> bbgb;
        proxy_type<2, 0, 1, 3> bbga;
        proxy_type<2, 0, 2, 0> bbbr;
        proxy_type<2, 0, 2, 1> bbbg;
        proxy_type<2, 0, 2, 2> bbbb;
        proxy_type<2, 0, 2, 3> bbba;
        proxy_type<2, 0, 3, 0> bbar;
        proxy_type<2, 0, 3, 1> bbag;
        proxy_type<2, 0, 3, 2> bbab;
        proxy_type<2, 0, 3, 3> bbaa;
        proxy_type<2, 0, 0, 0> barr;
        proxy_type<2, 0, 0, 1> barg;
        proxy_type<2, 0, 0, 2> barb;
        proxy_type<2, 0, 0, 3> bara;
        proxy_type<2, 0, 1, 0> bagr;
        proxy_type<2, 0, 1, 1> bagg;
        proxy_type<2, 0, 1, 2> bagb;
        proxy_type<2, 0, 1, 3> baga;
        proxy_type<2, 0, 2, 0> babr;
        proxy_type<2, 0, 2, 1> babg;
        proxy_type<2, 0, 2, 2> babb;
        proxy_type<2, 0, 2, 3> baba;
        proxy_type<2, 0, 3, 0> baar;
        proxy_type<2, 0, 3, 1> baag;
        proxy_type<2, 0, 3, 2> baab;
        proxy_type<2, 0, 3, 3> baaa;
        ...
        proxy_type<3, 0, 0, 0> agrr;
        proxy_type<3, 0, 0, 1> agrg;
        proxy_type<3, 0, 0, 2> agrb;
        proxy_type<3, 0, 0, 3> agra;
        proxy_type<3, 0, 1, 0> aggr;
        proxy_type<3, 0, 1, 1> aggg;
        proxy_type<3, 0, 1, 2> aggb;
        proxy_type<3, 0, 1, 3> agga;
        proxy_type<3, 0, 2, 0> agbr;
        proxy_type<3, 0, 2, 1> agbg;
        proxy_type<3, 0, 2, 2> agbb;
        proxy_type<3, 0, 2, 3> agba;
        proxy_type<3, 0, 3, 0> agar;
        proxy_type<3, 0, 3, 1> agag;
        proxy_type<3, 0, 3, 2> agab;
        proxy_type<3, 0, 3, 3> agaa;
        proxy_type<3, 0, 0, 0> abrr;
        proxy_type<3, 0, 0, 1> abrg;
        proxy_type<3, 0, 0, 2> abrb;
        proxy_type<3, 0, 0, 3> abra;
        proxy_type<3, 0, 1, 0> abgr;
        proxy_type<3, 0, 1, 1> abgg;
        proxy_type<3, 0, 1, 2> abgb;
        proxy_type<3, 0, 1, 3> abga;
        proxy_type<3, 0, 2, 0> abbr;
        proxy_type<3, 0, 2, 1> abbg;
        proxy_type<3, 0, 2, 2> abbb;
        proxy_type<3, 0, 2, 3> abba;
        proxy_type<3, 0, 3, 0> abar;
        proxy_type<3, 0, 3, 1> abag;
        proxy_type<3, 0, 3, 2> abab;
        proxy_type<3, 0, 3, 3> abaa;
        proxy_type<3, 0, 0, 0> aarr;
        proxy_type<3, 0, 0, 1> aarg;
        proxy_type<3, 0, 0, 2> aarb;
        proxy_type<3, 0, 0, 3> aara;
        proxy_type<3, 0, 1, 0> aagr;
        proxy_type<3, 0, 1, 1> aagg;
        proxy_type<3, 0, 1, 2> aagb;
        proxy_type<3, 0, 1, 3> aaga;
        proxy_type<3, 0, 2, 0> aabr;
        proxy_type<3, 0, 2, 1> aabg;
        proxy_type<3, 0, 2, 2> aabb;
        proxy_type<3, 0, 2, 3> aaba;
        proxy_type<3, 0, 3, 0> aaar;
        proxy_type<3, 0, 3, 1> aaag;
        proxy_type<3, 0, 3, 2> aaab;
        proxy_type<3, 0, 3, 3> aaaa;
        ...
        proxy_type<0, 0, 0, 0> stss;
        proxy_type<0, 0, 0, 1> stst;
        proxy_type<0, 0, 0, 2> stsp;
        proxy_type<0, 0, 0, 3> stsq;
        proxy_type<0, 0, 1, 0> stts;
        proxy_type<0, 0, 1, 1> sttt;
        proxy_type<0, 0, 1, 2> sttp;
        proxy_type<0, 0, 1, 3> sttq;
        proxy_type<0, 0, 2, 0> stps;
        proxy_type<0, 0, 2, 1> stpt;
        proxy_type<0, 0, 2, 2> stpp;
        proxy_type<0, 0, 2, 3> stpq;
        proxy_type<0, 0, 3, 0> stqs;
        proxy_type<0, 0, 3, 1> stqt;
        proxy_type<0, 0, 3, 2> stqp;
        proxy_type<0, 0, 3, 3> stqq;
        proxy_type<0, 0, 0, 0> spss;
        proxy_type<0, 0, 0, 1> spst;
        proxy_type<0, 0, 0, 2> spsp;
        proxy_type<0, 0, 0, 3> spsq;
        proxy_type<0, 0, 1, 0> spts;
        proxy_type<0, 0, 1, 1> sptt;
        proxy_type<0, 0, 1, 2> sptp;
        proxy_type<0, 0, 1, 3> sptq;
        proxy_type<0, 0, 2, 0> spps;
        proxy_type<0, 0, 2, 1> sppt;
        proxy_type<0, 0, 2, 2> sppp;
        proxy_type<0, 0, 2, 3> sppq;
        proxy_type<0, 0, 3, 0> spqs;
        proxy_type<0, 0, 3, 1> spqt;
        proxy_type<0, 0, 3, 2> spqp;
        proxy_type<0, 0, 3, 3> spqq;
        proxy_type<0, 0, 0, 0> sqss;
        proxy_type<0, 0, 0, 1> sqst;
        proxy_type<0, 0, 0, 2> sqsp;
        proxy_type<0, 0, 0, 3> sqsq;
        proxy_type<0, 0, 1, 0> sqts;
        proxy_type<0, 0, 1, 1> sqtt;
        proxy_type<0, 0, 1, 2> sqtp;
        proxy_type<0, 0, 1, 3> sqtq;
        proxy_type<0, 0, 2, 0> sqps;
        proxy_type<0, 0, 2, 1> sqpt;
        proxy_type<0, 0, 2, 2> sqpp;
        proxy_type<0, 0, 2, 3> sqpq;
        proxy_type<0, 0, 3, 0> sqqs;
        proxy_type<0, 0, 3, 1> sqqt;
        proxy_type<0, 0, 3, 2> sqqp;
        proxy_type<0, 0, 3, 3> sqqq;
        proxy_type<1, 0, 0, 0> tsss;
        proxy_type<1, 0, 0, 1> tsst;
        proxy_type<1, 0, 0, 2> tssp;
        ...
        proxy_type<1, 0, 0, 0> ttss;
        proxy_type<1, 0, 0, 1> ttst;
        proxy_type<1, 0, 0, 2> ttsp;
        proxy_type<1, 0, 0, 3> ttsq;
        proxy_type<1, 0, 1, 0> ttts;
        proxy_type<1, 0, 1, 1> tttt;
        proxy_type<1, 0, 1, 2> tttp;
        proxy_type<1, 0, 1, 3> tttq;
        proxy_type<1, 0, 2, 0> ttps;
        proxy_type<1, 0, 2, 1> ttpt;
        proxy_type<1, 0, 2, 2> ttpp;
        proxy_type<1, 0, 2, 3> ttpq;
        proxy_type<1, 0, 3, 0> ttqs;
        proxy_type<1, 0, 3, 1> ttqt;
        proxy_type<1, 0, 3, 2> ttqp;
        proxy_type<1, 0, 3, 3> ttqq;
        proxy_type<1, 0, 0, 0> tpss;
        proxy_type<1, 0, 0, 1> tpst;
        proxy_type<1, 0, 0, 2> tpsp;
        proxy_type<1, 0, 0, 3> tpsq;
        proxy_type<1, 0, 1, 0> tpts;
        proxy_type<1, 0, 1, 1> tptt;
        proxy_type<1, 0, 1, 2> tptp;
        proxy_type<1, 0, 1, 3> tptq;
        proxy_type<1, 0, 2, 0> tpps;
        proxy_type<1, 0, 2, 1> tppt;
        proxy_type<1, 0, 2, 2> tppp;
        proxy_type<1, 0, 2, 3> tppq;
        proxy_type<1, 0, 3, 0> tpqs;
        proxy_type<1, 0, 3, 1> tpqt;
        proxy_type<1, 0, 3, 2> tpqp;
        proxy_type<1, 0, 3, 3> tpqq;
        proxy_type<1, 0, 0, 0> tqss;
        proxy_type<1, 0, 0, 1> tqst;
        proxy_type<1, 0, 0, 2> tqsp;
        proxy_type<1, 0, 0, 3> tqsq;
        proxy_type<1, 0, 1, 0> tqts;
        proxy_type<1, 0, 1, 1> tqtt;
        proxy_type<1, 0, 1, 2> tqtp;
        proxy_type<1, 0, 1, 3> tqtq;
        proxy_type<1, 0, 2, 0> tqps;
        proxy_type<1, 0, 2, 1> tqpt;
        proxy_type<1, 0, 2, 2> tqpp;
        proxy_type<1, 0, 2, 3> tqpq;
        proxy_type<1, 0, 3, 0> tqqs;
        proxy_type<1, 0, 3, 1> tqqt;
        proxy_type<1, 0, 3, 2> tqqp;
        proxy_type<1, 0, 3, 3> tqqq;
        proxy_type<2, 0, 0, 0> psss;
        proxy_type<2, 0, 0, 1> psst;
        proxy_type<2, 0, 0, 2> pssp;
        ...
        proxy_type<2, 0, 0, 0> ptss;
        proxy_type<2, 0, 0, 1> ptst;
        proxy_type<2, 0, 0, 2> ptsp;
        proxy_type<2, 0, 0, 3> ptsq;
        proxy_type<2, 0, 1, 0> ptts;
        proxy_type<2, 0, 1, 1> pttt;
        proxy_type<2, 0, 1, 2> pttp;
        proxy_type<2, 0, 1, 3> pttq;
        proxy_type<2, 0, 2, 0> ptps;
        proxy_type<2, 0, 2, 1> ptpt;
        proxy_type<2, 0, 2, 2> ptpp;
        proxy_type<2, 0, 2, 3> ptpq;
        proxy_type<2, 0, 3, 0> ptqs;
        proxy_type<2, 0, 3, 1> ptqt;
        proxy_type<2, 0, 3, 2> ptqp;
        proxy_type<2, 0, 3, 3> ptqq;
        proxy_type<2, 0, 0, 0> ppss;
        proxy_type<2, 0, 0, 1> ppst;
        proxy_type<2, 0, 0, 2> ppsp;
        proxy_type<2, 0, 0, 3> ppsq;
        proxy_type<2, 0, 1, 0> ppts;
        proxy_type<2, 0, 1, 1> pptt;
        proxy_type<2, 0, 1, 2> pptp;
        proxy_type<2, 0, 1, 3> pptq;
        proxy_type<2, 0, 2, 0> ppps;
        proxy_type<2, 0, 2, 1> pppt;
        proxy_type<2, 0, 2, 2> pppp;
        proxy_type<2, 0, 2, 3> pppq;
        proxy_type<2, 0, 3, 0> ppqs;
        proxy_type<2, 0, 3, 1> ppqt;
        proxy_type<2, 0, 3, 2> ppqp;
        proxy_type<2, 0, 3, 3> ppqq;
        proxy_type<2, 0, 0, 0> pqss;
        proxy_type<2, 0, 0, 1> pqst;
        proxy_type<2, 0, 0, 2> pqsp;
        proxy_type<2, 0, 0, 3> pqsq;
        proxy_type<2, 0, 1, 0> pqts;
        proxy_type<2, 0, 1, 1> pqtt;
        proxy_type<2, 0, 1, 2> pqtp;
        proxy_type<2, 0, 1, 3> pqtq;
        proxy_type<2, 0, 2, 0> pqps;
        proxy_type<2, 0, 2, 1> pqpt;
        proxy_type<2, 0, 2, 2> pqpp;
        proxy_type<2, 0, 2, 3> pqpq;
        proxy_type<2, 0, 3, 0> pqqs;
        proxy_type<2, 0, 3, 1> pqqt;
        proxy_type<2, 0, 3, 2> pqqp;
        proxy_type<2, 0, 3, 3> pqqq;
        ...
        proxy_type<3, 0, 0, 0> qtss;
        proxy_type<3, 0, 0, 1> qtst;
        proxy_type<3, 0, 0, 2> qtsp;
        proxy_type<3, 0, 0, 3> qtsq;
        proxy_type<3, 0, 1, 0> qtts;
        proxy_type<3, 0, 1, 1> qttt;
        proxy_type<3, 0, 1, 2> qttp;
        proxy_type<3, 0, 1, 3> qttq;
        proxy_type<3, 0, 2, 0> qtps;
        proxy_type<3, 0, 2, 1> qtpt;
        proxy_type<3, 0, 2, 2> qtpp;
        proxy_type<3, 0, 2, 3> qtpq;
        proxy_type<3, 0, 3, 0> qtqs;
        proxy_type<3, 0, 3, 1> qtqt;
        proxy_type<3, 0, 3, 2> qtqp;
        proxy_type<3, 0, 3, 3> qtqq;
        proxy_type<3, 0, 0, 0> qpss;
        proxy_type<3, 0, 0, 1> qpst;
        proxy_type<3, 0, 0, 2> qpsp;
        proxy_type<3, 0, 0, 3> qpsq;
        proxy_type<3, 0, 1, 0> qpts;
        proxy_type<3, 0, 1, 1> qptt;
        proxy_type<3, 0, 1, 2> qptp;
        proxy_type<3, 0, 1, 3> qptq;
        proxy_type<3, 0, 2, 0> qpps;
        proxy_type<3, 0, 2, 1> qppt;
        proxy_type<3, 0, 2, 2> qppp;
        proxy_type<3, 0, 2, 3> qppq;
        proxy_type<3, 0, 3, 0> qpqs;
        proxy_type<3, 0, 3, 1> qpqt;
        proxy_type<3, 0, 3, 2> qpqp;
        proxy_type<3, 0, 3, 3> qpqq;
        proxy_type<3, 0, 0, 0> qqss;
        proxy_type<3, 0, 0, 1> qqst;
        proxy_type<3, 0, 0, 2> qqsp;
        proxy_type<3, 0, 0, 3> qqsq;
        proxy_type<3, 0, 1, 0> qqts;
        proxy_type<3, 0, 1, 1> qqtt;
        proxy_type<3, 0, 1, 2> qqtp;
        proxy_type<3, 0, 1, 3> qqtq;
        proxy_type<3, 0, 2, 0> qqps;
        proxy_type<3, 0, 2, 1> qqpt;
        proxy_type<3, 0, 2, 2> qqpp;
        proxy_type<3, 0, 2, 3> qqpq;
        proxy_type<3, 0, 3, 0> qqqs;
        proxy_type<3, 0, 3, 1> qqqt;
        proxy_type<3, 0, 3, 2> qqqp;
        proxy_type<3, 0, 3, 3> qqqq;
    };
